...
//     count: 0
// }
//todo postAdapter already creates a posts:[] there's no need to write it
...
export const selectPostsByUser = createSelector(
    [selectAllPosts, (state, userId) => userId], //? state, userId are passed into selectPostsByUser(state, Number(userId))) like this
